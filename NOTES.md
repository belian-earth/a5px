# a5cog — overnight prototype notes
...
- Threading: `a5cog_set_threads(n)` and `a5cog_get_threads()`. Per-call
...
for 264 k cells covering this raster. a5cog skips this entirely.
...
R/
  ...
  threads.R                           # a5cog_set_threads / a5cog_get_threads
  utils.R                             # check_resolution, new_a5_cell_from_rs, etc.
  zzz.R                               # .onLoad — picks up A5COG_NUM_THREADS / option
